      ...
      layers.push(
          {
              ...
              type: 'polygon',
              activeColor: '#0D47A1',
              url: `https://geoserver.ecds.emory.edu/AtlantaAnnexations/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=AtlantaAnnexations:Annex_${year}_whole&maxFeatures=500&outputFormat=application%2Fjson`,
              zIndex: 400 + (YEARS.length - index),
              clickable: true,
      ...
      layers.push(
          {
              ...
              type: 'polygon',
              activeColor: color,
              url: `https://geoserver.ecds.emory.edu/AtlantaAnnexations/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=AtlantaAnnexations:Annex_${year}_part&maxFeatures=500&outputFormat=application%2Fjson`,
              zIndex: 400 + (YEARS.length - index),
              clickable: true,
              displayProperty: 'YEAR',
              year: year,
