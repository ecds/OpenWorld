...
export const YEARS = [
  1847, 1854, 1863, 1866, 1889, 1894, 1895, 1904, 1909, 1910, 1913, 1914, 1915,
  1916, 1922, 1923, 1925, 1926, 1928, 1930, 1932, 1934, 1940, 1943, 1945,
];

export const annexDetails: TAnnexDetails[] = [
  {
    year: 1847,
    acreage: "2,010.60",
    areas:
  ...
  },
  {
    ...
    acreage: 286,
    areas:
      "To the southeast 286 acres were annexed in an area south of the Georgia Railroad in a wedge between what is now Oakland Cemetery and Grant Park. The area includes portions of present day Glenwood Park, Grant Park, and Ormewood Park.",
  },
  {
    year: 1866,
    acreage: "2,476",
    areas:
      "The city limits were expanded to a one and a half mile radius from the Union Depot. This added 2,476 acres to the city.",
  },
  {
    year: 1889,
    acreage: "1,547",
    areas:
      "The city limits were expanded 1,547 acres at a one and three quarter mile from the Union Depot.",
  },
  {
    year: 1894,
    acreage: 665,
  ...
  },
  {
    ...
    acreage: 143,
    areas:
      "The city gained 143 acres to the northeast extending beyond Old Fourth Ward and north of the Georgia Railroad Line. This area includes present day Freedom Parkway, Inman Park, and ended its expansion at what is now Moreland Avenue in Little Five Points.",
  },
  {
    year: 1904,
    acreage: 822,
    areas:
      "Northern expansion of the city to include the area that is now all of Midtown.",
  },
  {
    year: 1909,
    acreage: "2,612",
    areas:
      "A large expansion of 2,612 acres was made to the east of city and was designated a ninth ward. It included the areas of Copenhill, Druid Hills, East Atlanta, Edgewood, and Reynoldstown.",
  },
  {
    year: 1910,
    acreage: "5,606",
  ...
  },
  {
    ...
    acreage: 9,
    areas:
      "A small sliver, 9 acres, to the east of the city was annexed that is just to the west of Lake Claire and north of the Georgia Railroad Line. ",
  },
  {
    year: 1915,
    acreage: 75,
    areas:
      "Between Piedmont and Orme Park following Monroe Drive 75 acres was annexed to the north-northeast of the city.",
  },
  {
    year: 1916,
    acreage: 103,
    areas:
      "To the east of Orme Park in the northeastern part of the city 103 acres was added in the area that is the commercial district of present day Virginia Highlands.",
  },
  {
    year: 1922,
    acreage: "2,481",
  ...
  },
  {
    ...
    acreage: 411,
    areas:
      "On the southwest part of the city 411 acres were annexed in the areas of Utoy Creek and along Cascade Road just to the east of Greenwood Cemetery.",
  },
  {
    year: 1925,
    acreage: "1,164",
  ...
  },
  {
    ...
    acreage: "1,429",
    areas:
      "This added a large tract southeast of the city, East Lake except for the golf course and a residential area directly to the east of Ansley Park was added totaling to 1,429 acres.",
  },
  {
    year: 1930,
    acreage: 31,
    areas:
      "A 31 acre residential tract was added adjacent to Westview Cemetery’s eastside.",
  },
  {
    year: 1932,
    acreage: 110,
    areas:
      "A tract of 110 acres was added to the city in the area north of Rock Springs Road in the Morningside-Lenox Park area.",
  },
  {
    year: 1934,
    acreage: 24,
    areas:
      "A small tract of 24 acres was added to city which is located to the southeast of the intersections of Rock Springs Road and North Highland Avenue.",
  },
  {
    year: 1940,
    acreage: 150,
    areas:
      "The southern portion of the area annexed in 1934 was added to city which is located to the southeast of the intersections of Rock Springs Road and North Highland Avenue. To the west a large tract of what is now John A. White Park was added. Both tracts added 150 acres to the city.",
  },
  {
    year: 1943,
    acreage: 13,
    areas:
      "A small tract of 13 acres was added to the south of Olmsted Linear Park in the Lake Claire area of the city.",
  },
  {
    year: 1945,
    acreage: 355,
    areas:
      "To the east of Ansley Park the city was expanded further north in the Morningside-Lenox Park area and an area along Sugar Creek was added just north of Glenwood Avenue. Both tracts added 355 acres to the city.",
  },
];
